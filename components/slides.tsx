...
export const slides: Slide[] = [
    {
        id: "intro",
        content: (
            <div className="relative w-full min-h-[400px] md:h-[600px] rounded-[32px] md:rounded-[40px] overflow-hidden flex flex-col justify-end p-6 md:p-12">
                ...
                <div className="relative z-10 max-w-4xl space-y-6">
                    ...
                    <div className="space-y-4">
                        <motion.h1
                            ...
                            className="text-3xl sm:text-4xl md:text-7xl font-display font-extrabold tracking-tight text-slate-900 leading-[1.2] md:leading-[1.1]"
                        >
        ...
        content: (
            <div className="space-y-12 h-full flex flex-col justify-center">
                <div className="text-center space-y-4">
                    ...
                    <h2 className="text-3xl md:text-5xl font-display font-bold text-slate-900 tracking-tight">Landasan Hukum & Kebijakan</h2>
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg">Pilar utama transformasi layanan desa yang terintegrasi secara nasional.</p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8 relative z-10">
                    ...
                    {/* Pillar 2 */}
                    <div className="glass p-6 md:p-8 rounded-[32px] border border-emerald-100 bg-gradient-to-b from-emerald-50/50 to-white shadow-lg relative overflow-hidden group hover:shadow-xl transition-all transform md:-translate-y-4">
                    ...
                    <div className="md:col-span-7 space-y-8 pr-0 md:pr-8">
                        <div className="space-y-4">
                            ...
                            <h2 className="text-3xl md:text-5xl font-display font-extrabold text-slate-900 tracking-tight leading-tight">
                                Visi & Misi <br className="hidden sm:block" />
        ...
        content: (
            <div className="space-y-10 h-full flex flex-col justify-center">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg">Ekosistem terintegrasi dari input warga hingga output kebijakan pimpinan desa, didukung teknologi AI & IoT.</p>
                </div>

                <div className="relative glass p-6 md:p-10 rounded-[40px] border border-slate-200 shadow-2xl overflow-hidden bg-white">
        ...
        content: (
            <div className="space-y-10 h-full flex flex-col justify-center">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg">Satu basis data tunggal yang melayani seluruh kanal akses — dari genggaman warga hingga meja pimpinan.</p>
                </div>
        ...
        content: (
            <div className="space-y-10 h-full flex flex-col justify-center">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg">Seluruh sistem adalah aset desa — data tersimpan lokal, bisa dikustomisasi, dan dikembangkan sesuai visi masing-masing desa.</p>
                </div>
                ...
                <div className="grid md:grid-cols-12 gap-12 items-center">
                    <div className="md:col-span-7 space-y-8">
                        <div className="space-y-4">
                            ...
                            <h2 className="text-3xl md:text-6xl font-display font-extrabold text-slate-900 leading-tight">
                                Kedaulatan & <br className="hidden sm:block" />
        ...
        content: (
            <div className="space-y-10 h-full flex flex-col justify-center">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg">Seluruh layanan desa dalam satu platform — dari persuratan hingga keuangan, semua transparan dan instan.</p>
                </div>
        ...
        content: (
            <div className="space-y-12">
                <div className="text-center space-y-4">
                    ...
                    <h2 className="text-3xl md:text-5xl font-display font-bold text-slate-900 leading-tight">Arsitektur Data Driven</h2>
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg">Dari ragam sumber data mentah menjadi keputusan strategis kepala desa secara instan.</p>
                </div>
                ...
                <div className="glass p-8 rounded-[40px] border border-slate-200 bg-white shadow-xl relative overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
                        ...
                        <div className="flex flex-col items-center gap-4 shrink-0 px-4 md:px-8">
                            ...
                            <div className="w-24 h-24 md:w-32 md:h-32 rounded-3xl bg-primary-600 text-slate-900 flex flex-col items-center justify-center shadow-2xl relative">
                                <div className="absolute inset-0 bg-slate-200 rounded-3xl animate-ping opacity-20" />
                                <Brain className="w-8 h-8 md:w-10 md:h-10 mb-2" />
                                <span className="font-bold text-center text-[10px] md:text-sm leading-tight">Data<br />Lake Desa</span>
                            </div>
                            <div className="text-slate-600 hidden md:block">
                                <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
    ...
    },
    {
        ...
        content: (
            <div className="space-y-12">
                <div className="text-center space-y-4">
                    <h2 className="text-3xl md:text-4xl font-display font-bold text-slate-900">3 Pilar Utama Digitalisasi</h2>
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">Fondasi dasar pengembangan ekosistem digital pedesaan yang berkelanjutan.</p>
                </div>
                <div className="grid md:grid-cols-3 gap-6">
                    {[
                        ...
                        <motion.div
                            ...
                            className="glass p-6 md:p-8 rounded-3xl space-y-4 border border-slate-200"
                        >
    ...
    },
    {
        ...
        content: (
            <div className="space-y-12">
                <div className="text-center space-y-4">
                    <h2 className="text-3xl md:text-4xl font-display font-bold text-slate-900">Ekosistem SID di Indonesia</h2>
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">Platform dominan yang telah membantu ribuan desa beralih ke digital.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="glass p-6 md:p-8 rounded-3xl border border-slate-200 space-y-4">
                        <div className="flex items-center gap-3">
        ...
        content: (
            <div className="space-y-10 h-full flex flex-col justify-center">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg">Implementasi Inpres No. 9 Tahun 2025 — Membangun 80.000 koperasi desa sebagai motor ekonomi kerakyatan.</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                    {/* Left: Info Cards */}
                    <div className="md:col-span-5 space-y-5">
                        <div className="glass p-5 md:p-6 rounded-[28px] border border-red-100 bg-gradient-to-b from-red-50/50 to-white shadow-lg relative overflow-hidden">
                    ...
                    <div className="md:col-span-7 space-y-5">
                        <div className="glass p-6 md:p-8 rounded-[32px] border border-slate-200 bg-white shadow-lg">
        ...
        content: (
            <div className="space-y-10 h-full flex flex-col justify-center">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg">Integrasi data Posyandu, ibu hamil, dan balita ke dashboard pimpinan desa untuk early warning gizi buruk.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="glass p-6 md:p-8 rounded-[32px] border border-pink-100 bg-gradient-to-b from-pink-50/30 to-white shadow-lg relative overflow-hidden">
        ...
        content: (
            <div className="space-y-10 h-full flex flex-col justify-center">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">Digitalisasi distribusi dan monitoring program MBG agar transparan, tepat sasaran, dan terukur di setiap desa.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        ...
                        <motion.div
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ delay: i * 0.1 }}
                            className={`glass p-6 md:p-8 rounded-[32px] border ${item.color.split(' ')[2]} bg-white shadow-lg relative overflow-hidden hover:shadow-xl transition-all`}
                        >
                            <div className={`absolute top-0 inset-x-0 h-1 bg-gradient-to-r ${item.accent}`} />
        ...
        content: (
            <div className="space-y-10 h-full flex flex-col justify-center">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">Digitalisasi penyaluran Bantuan Langsung Tunai agar transparan, tepat sasaran, dan bebas dari manipulasi data.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                    <div className="md:col-span-7 glass p-6 md:p-8 rounded-[32px] border border-slate-200 bg-white shadow-lg">
        ...
        content: (
            <div className="space-y-10 h-full flex flex-col justify-center">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg">Promosi destinasi, booking online, dan ojek desa — seluruh ekosistem wisata terintegrasi dalam satu platform.</p>
                </div>
        ...
        content: (
            <div className="space-y-12">
                <div className="text-center space-y-4">
                    ...
                    <h2 className="text-3xl md:text-5xl font-display font-bold text-slate-900 leading-tight">Ketahanan Pangan & Ekosistem UMKM</h2>
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg">Platform yang adaptif untuk segala jenis komoditas unggulan desa, dari pertanian hingga pariwisata.</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Ketahanan Pangan */}
                    <div className="glass p-6 md:p-8 rounded-[32px] border border-slate-200 bg-slate-100 space-y-6">
                        <div className="w-14 h-14 rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center mb-2">
                            <Sprout className="w-8 h-8" />
                        </div>
                        <h3 className="text-xl md:text-2xl font-bold text-slate-900">Ketahanan Pangan Digital</h3>
                        <p className="text-slate-600 text-xs md:text-sm leading-relaxed">Sistem pencatatan digital untuk memantau stok hasil bumi, memetakan lahan produktif, dan memprediksi masa panen secara akurat. Memastikan kemandirian pangan desa terjaga sepanjang tahun tanpa defisit.</p>
                    ...
                    <div className="glass p-6 md:p-8 rounded-[32px] border border-slate-200 bg-slate-100 space-y-6">
                        ...
                        <h3 className="text-xl md:text-2xl font-bold text-slate-900">Ekosistem UMKM & Desa Wisata</h3>
                        <p className="text-slate-600 text-xs md:text-sm leading-relaxed">Memberdayakan produk lokal agar naik kelas. Sistem ini sangat kompatibel dengan model bisnis apapun: baik desa penghasil kopi unggulan, sentra kerajinan, maupun destinasi desa wisata alam.</p>
                        <div className="space-y-3 pt-4 border-t border-slate-200">
                            {[
    ...
    },
    {
        id: "smart-village",
        content: (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center"> domains
                <div className="space-y-8">
                    <div className="space-y-2">
                        <div className="text-primary-600 font-bold text-sm tracking-widest uppercase">Next Generation</div>
                        <h2 className="text-3xl md:text-5xl font-display font-bold text-slate-900 leading-tight">Visi Smart Village</h2>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                        {[
    ...
    },
    {
        id: "integration",
        content: (
            <div className="space-y-8 md:space-y-12 h-full flex flex-col justify-center">
                <div className="text-center space-y-4">
                    <motion.div
                        initial={{ opacity: 0, y: -20 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary-50 border border-primary-100 text-primary-700 text-[10px] md:text-xs font-bold tracking-widest uppercase shadow-sm"
                    >
                        <Network className="w-3.5 h-3.5 md:w-4 h-4" /> Interoperabilitas Nasional
                    </motion.div>
                    <h2 className="text-3xl md:text-5xl font-display font-extrabold text-slate-900 tracking-tight leading-tight">
                        Integrasi Data <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-emerald-600">Multi-Sektoral</span>
                    </h2>
                    <p className="text-slate-500 max-w-2xl mx-auto text-sm md:text-lg leading-relaxed">Pemanfaatan data berstandar sesuai <span className="font-bold text-slate-900 border-b-2 border-primary-100">Perpres 39/2019</span> (Satu Data Indonesia) — satu input desa untuk semua kebutuhan nasional.</p>
                </div>

                <div className="relative flex justify-center items-center h-[300px] md:h-[450px]">
                    {/* Background Orbits */}
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-[200px] h-[200px] md:w-[350px] md:h-[350px] border border-dashed border-slate-200 rounded-full animate-[spin_20s_linear_infinite]" />
                        <div className="absolute w-[280px] h-[280px] md:w-[500px] md:h-[500px] border border-dashed border-slate-100 rounded-full animate-[spin_35s_linear_infinite_reverse]" />
                    </div>
                    ...
                    <motion.div
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                        className="relative z-20 w-32 h-32 md:w-48 md:h-48 rounded-[40px] bg-primary-600 shadow-2xl flex flex-col items-center justify-center p-4 border-8 border-white group"
                    >
                        <div className="absolute inset-0 bg-primary-400 rounded-[32px] animate-ping opacity-20" />
                        <Bot className="w-12 h-12 md:w-16 md:h-16 text-slate-900 mb-2 group-hover:scale-110 transition-transform" />
                        <span className="text-slate-900 font-black text-center text-sm md:text-xl leading-none uppercase tracking-tighter">SISAD<br />SUPER APP</span>
                    </motion.div>

                    {/* Satellite Nodes */}
                    {[
                        { label: "Dukcapil", sub: "Validasi NIK", pos: "top-0 md:-top-4 left-1/2 -translate-x-1/2", icon: <User className="w-5 h-5" />, color: "bg-blue-50 border-blue-100 text-blue-600", delay: 0.2 },
                        { label: "DTKS / SIK-NG", sub: "Akurasi Bansos", pos: "bottom-0 md:-bottom-4 left-1/2 -translate-x-1/2", icon: <ShieldCheck className="w-5 h-5" />, color: "bg-pink-50 border-pink-100 text-pink-600", delay: 0.4 },
                        { label: "Siskeudes", sub: "Keuangan Online", pos: "left-0 md:-left-4 top-1/2 -translate-y-1/2", icon: <Database className="w-5 h-5" />, color: "bg-emerald-50 border-emerald-100 text-emerald-600", delay: 0.6 },
                        { label: "Prodeskel", sub: "Evaluasi Desa", pos: "right-0 md:-right-4 top-1/2 -translate-y-1/2", icon: <Globe className="w-5 h-5" />, color: "bg-amber-50 border-amber-100 text-amber-600", delay: 0.8 },
                    ].map((node, i) => (
                        <motion.div
                            key={i}
                            ...
                            className={`absolute ${node.pos} z-30 flex flex-col items-center gap-2 group`}
                        >
                            <div className={`${node.color} p-4 md:p-6 rounded-3xl border shadow-xl group-hover:scale-110 transition-transform backdrop-blur-md`}>
                                {node.icon}
                            </div>
                            <div className="text-center px-4 py-2 bg-white/80 backdrop-blur-md rounded-2xl shadow-sm border border-slate-100 hidden md:block">
                                <h4 className="text-xs font-black text-slate-900">{node.label}</h4>
                                <p className="text-[9px] text-slate-500 font-bold uppercase tracking-widest">{node.sub}</p>
                            </div>
                            {/* Mobile Label */}
                            <span className="md:hidden text-[10px] font-black text-slate-700 bg-white/90 px-2 py-1 rounded-lg border border-slate-100">{node.label}</span>
                        </motion.div>
                    ))}

                    {/* Animated Data Lines (Visible on Desktop) */}
                ...
                <div className="glass p-5 rounded-[28px] border border-primary-100 flex items-center gap-4 bg-gradient-to-r from-primary-50/50 to-white mt-4 md:mt-8">
                    <div className="p-3 rounded-2xl bg-white shadow-sm ring-4 ring-primary-50">
                        <Link className="w-6 h-6 text-primary-600" />
                    </div>
                    <p className="text-xs md:text-sm text-slate-700 leading-relaxed font-medium">
                        Sistem menggunakan standar <span className="font-bold text-slate-900">Open Data API</span> — Memungkinkan integrasi dua arah (sinkronisasi) dengan portal Data Kabupaten, Provinsi, hingga Pusat secara instan & aman.
                    </p>
                </div>
            </div>
        ),
        ...
        content: (
            <>
                ...
                <div className="text-center space-y-4 relative z-10">
                    ...
                    <h2 className="text-3xl md:text-6xl font-display font-extrabold text-slate-900 tracking-tight">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg">Membawa kecerdasan buatan ke level akar rumput untuk pelayanan yang lebih prediktif dan responsif.</p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6 relative z-10">
                    {[
                        ...
                        <motion.div
                            ...
                            className={`group relative p-6 md:p-8 rounded-[36px] bg-gradient-to-br ${item.color} border ${item.border} backdrop-blur-sm shadow-xl overflow-hidden`}
                        >
                            ...
                            <div className="space-y-3">
                                <h3 className="text-xl md:text-2xl font-black text-slate-900 tracking-tight leading-none">{item.title}</h3>
    ...
    },
    {
        ...
        content: (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                <div className="space-y-8">
                    <div className="space-y-4">
                        <h2 className="text-3xl md:text-5xl font-display font-bold text-slate-900 leading-tight">Infrastruktur Berbasis IoT</h2>
                        <p className="text-slate-500 text-base md:text-lg">Sensor cerdas yang mengoptimalkan produktivitas dan keamanan lingkungan desa secara real-time.</p>
                    </div>
                    <div className="space-y-4">
                        {[
                            {
                            ...
                            <div key={i} className="flex gap-4 p-4 md:p-5 rounded-3xl bg-slate-100 border border-slate-200">
                ...
                <div className="relative aspect-square">
                    ...
                    <div className="relative h-full glass p-6 md:p-8 rounded-[40px] border border-white flex flex-col justify-center items-center gap-8 shadow-2xl">
                        <div className="relative">
            ...
            <div className="space-y-8 md:space-y-12 h-full flex flex-col justify-center">
                <div className="text-center space-y-4">
                    <motion.div
                        initial={{ opacity: 0, y: -20 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-red-50 border border-red-100 text-red-700 text-[10px] md:text-xs font-bold tracking-widest uppercase shadow-sm"
                    >
                        <ShieldAlert className="w-3.5 h-3.5 md:w-4 h-4" /> Public Safety & Security
                    </motion.div>
                    <h2 className="text-3xl md:text-5xl font-display font-extrabold text-slate-900 tracking-tight leading-tight">
                        Pusat Komando & <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-indigo-600">Keselamatan Warga</span>
                    </h2>
                    <p className="text-slate-500 max-w-2xl mx-auto text-sm md:text-lg leading-relaxed">Sistem respon cepat yang menghubungkan warga langsung ke unit reaksi darurat desa dalam hitungan detik.</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
                    {/* Left: Command Center Visualization */}
                    <div className="md:col-span-7 relative group">
                        <div className="absolute -inset-4 bg-red-100/30 rounded-[40px] blur-3xl opacity-0 group-hover:opacity-100 transition-opacity" />
                        <div className="relative glass p-6 md:p-8 rounded-[40px] border border-red-50 bg-white/80 backdrop-blur-md shadow-2xl overflow-hidden">
                            <div className="flex items-center justify-between mb-8">
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-red-600 text-white flex items-center justify-center shadow-lg shadow-red-200 animate-pulse">
                                        <PhoneCall className="w-6 h-6 md:w-8 md:h-8" />
                                    </div>
                                    <div>
                                        <h3 className="text-xl md:text-2xl font-black text-slate-900 tracking-tighter">CALL CENTER 24/7</h3>
                                        <div className="flex items-center gap-2">
                                            <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                                            <p className="text-[10px] md:text-xs font-mono text-slate-500 uppercase tracking-widest">Operator Active</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="hidden md:block px-4 py-2 rounded-xl bg-slate-900 text-white text-[10px] font-black uppercase tracking-[0.2em]">
                                    Emergency Hub
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {[
                                    { label: "Ambulans Desa", val: "SIAGA 24 JAM", icon: <Activity className="w-5 h-5" />, color: "text-blue-600 bg-blue-50" },
                                    { label: "Panic Button SOS", val: "RESPON < 5 MENIT", icon: <Zap className="w-5 h-5" />, color: "text-red-600 bg-red-50" },
                                    { label: "Damkar & Relawan", val: "READY-TO-DEPLOY", icon: <Flame className="w-5 h-5" />, color: "text-orange-600 bg-orange-50" },
                                    { label: "Pos Keamanan", val: "PATROLI DIGITAL", icon: <ShieldCheck className="w-5 h-5" />, color: "text-indigo-600 bg-indigo-50" },
                                ].map((item, i) => (
                                    <div key={i} className="flex items-center gap-4 p-4 rounded-2xl bg-white border border-slate-100 shadow-sm hover:border-red-200 transition-colors">
                    ...
                    {/* Right: Feedback & Reporting */}
                    <div className="md:col-span-5 space-y-6">
                        <div className="glass p-6 md:p-8 rounded-[40px] border border-slate-200 bg-white shadow-xl relative overflow-hidden">
                            ...
                            <div className="relative z-10 space-y-4">
                                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 border border-indigo-100 text-indigo-700 text-[10px] font-bold uppercase tracking-widest">
                                    <Bot className="w-3.5 h-3.5" /> Aspirasi Warga
                                </div>
                                <h3 className="text-xl md:text-2xl font-black text-slate-900 leading-tight">Sistem Aduan & LAPOR!</h3>
                                <p className="text-sm text-slate-600 leading-relaxed">
                                    Membangun jembatan komunikasi transparan. Setiap aduan warga terlacak, memiliki nomor tiket, dan terpantau progresnya oleh Kepala Desa.
                                </p>
                            </div>
                        </div>

                        <div className="p-6 rounded-[32px] bg-gradient-to-br from-indigo-600 to-blue-700 text-white shadow-xl relative overflow-hidden group">
                            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.1),transparent)]" />
                            <div className="relative z-10 space-y-4">
                                <div className="flex justify-between items-center">
                                    <p className="text-[10px] font-bold uppercase tracking-[0.2em] opacity-80">Guaranteed Response</p>
                                    <div className="flex gap-1">
                                        {[1, 2, 3, 4, 5].map(star => <div key={star} className="w-2 h-2 bg-amber-400 rounded-full" />)}
                                    </div>
                                </div>
                                <h4 className="text-2xl md:text-3xl font-black tracking-tighter italic">"Respon Maksimal 1x24 Jam"</h4>
                                <div className="pt-4 border-t border-white/10 flex items-center justify-between">
                                    <div className="flex -space-x-2">
                                        {[1, 2, 3].map(i => (
                                            <div key={i} className="w-8 h-8 rounded-full border-2 border-indigo-600 bg-slate-200" />
                                        ))}
                                        <div className="w-8 h-8 rounded-full border-2 border-indigo-600 bg-white flex items-center justify-center text-[8px] font-bold text-slate-900">+50</div>
                                    </div>
                                    <span className="text-[10px] font-bold uppercase tracking-widest opacity-80">Warga Puas Minggu Ini</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        content: (
            <div className="space-y-10 h-full flex flex-col justify-center">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">Platform desa menjadi feeder data ke sistem nasional — memenuhi mandat Perpres 39/2019 tentang Satu Data Indonesia.</p>
                </div>
                <div className="glass p-6 md:p-10 rounded-[40px] border border-slate-200 bg-white shadow-2xl relative overflow-hidden">
        ...
        content: (
            <div className="space-y-10 h-full flex flex-col justify-center">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg">Platform otomatis melacak 18 indikator SDGs Desa dari Kemendes PDTT — tanpa input manual.</p>
                </div>
        ...
        content: (
            <div className="space-y-12 h-full flex flex-col justify-center relative overflow-hidden">
                ...
                <div className="text-center space-y-4 relative z-10">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">Memberdayakan masyarakat melalui akses layanan digital yang inklusif, transparan, dan responsif.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div className="space-y-6">
                        {[
                            ...
                            <div key={i} className="flex gap-6 p-5 md:p-6 rounded-[24px] bg-slate-100 border border-slate-200">
                    ...
                    <div className="relative glass p-6 md:p-8 rounded-[40px] border border-emerald-100 bg-gradient-to-br from-emerald-50 to-white shadow-2xl flex flex-col gap-8 h-full min-h-[400px]">
        ...
        content: (
            <div className="space-y-10 h-full flex flex-col justify-center">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">Pendampingan intensif untuk aparatur desa dan warga agar adopsi teknologi berjalan lancar dan berkelanjutan.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                    ...
                    <div className="glass p-6 md:p-8 rounded-[32px] border border-violet-100 bg-gradient-to-b from-violet-50/30 to-white shadow-lg relative overflow-hidden">
        ...
        content: (
            <div className="space-y-10 h-full flex flex-col justify-center">
                <div className="text-center space-y-4">
                    ...
                    <h2 className="text-3xl md:text-5xl font-display font-extrabold text-slate-900 tracking-tight">
                        Jasa Konsultasi & <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-blue-600">Strategic Advisor</span>
                    </h2>
                    <div className="flex flex-col items-center gap-2">
                        <p className="text-slate-500 text-base md:text-lg font-medium">Investasi Keahlian untuk Transformasi Digital Desa yang Terpadu.</p>
                        <div className="mt-4 px-6 py-4 bg-slate-900 rounded-[24px] border border-slate-700 shadow-2xl relative overflow-hidden group">
                            <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                            <span className="text-slate-400 text-[10px] font-bold uppercase tracking-[0.2em] block mb-1">Estimasi Investasi</span>
                            <span className="text-2xl md:text-4xl font-black text-white">Rp 7.500.000 – Rp 15.000.000 <span className="text-sm font-normal text-slate-400">/ Desa</span></span>
                        </div>
                    </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                    <div className="glass p-6 md:p-8 rounded-[32px] border border-slate-200 bg-white shadow-lg space-y-6">
                        <div className="flex items-center gap-3">
                            <div className="p-2.5 rounded-xl bg-indigo-50 text-indigo-600 shadow-sm border border-indigo-100">
                                <Settings2 className="w-6 h-6" />
                            </div>
                            <h3 className="text-xl font-bold text-slate-900">Matriks Kompleksitas</h3>
                        </div>
                        <p className="text-sm text-slate-500 leading-relaxed italic border-l-2 border-indigo-200 pl-4">
                            Biaya ditentukan berdasarkan hasil "Initial Assessment" terhadap rintangan teknis dan administratif.
                        </p>

                        <div className="space-y-3">
                            {[
                                { label: "Kualitas Data Awal", desc: "Kerapihan arsip kependudukan & aset desa.", icon: <Database className="w-4 h-4" /> },
                                { label: "Dukungan Infrastruktur", desc: "Kondisi jaringan & ketersediaan perangkat.", icon: <Wifi className="w-4 h-4" /> },
                                { label: "Kompetensi SDM", desc: "Tingkat literasi digital perangkat desa.", icon: <Users className="w-4 h-4" /> },
                                { label: "Kesiapan Regulasi", desc: "Status AD/ART BUMDes & Peraturan Desa.", icon: <FileText className="w-4 h-4" /> }
                            ].map((item, i) => (
                                <div key={i} className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100 group hover:border-indigo-200 hover:bg-white transition-all">
                                    <div className="flex items-center gap-3">
                                        <div className="p-2 rounded-lg bg-white shadow-sm text-slate-400 group-hover:text-indigo-600 transition-colors border border-slate-100">{item.icon}</div>
                                        <div>
                                            <h4 className="text-sm font-bold text-slate-900">{item.label}</h4>
                                            <p className="text-[10px] text-slate-500">{item.desc}</p>
                                        </div>
                                    </div>
                                    <div className="px-2 py-1 rounded-md bg-white border border-slate-200 text-[8px] font-bold text-slate-400 uppercase tracking-wider">Audit Point</div>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 flex flex-col justify-center">
                        <div className="p-8 rounded-[32px] bg-slate-900 text-white shadow-2xl relative overflow-hidden group">
                            <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:scale-110 transition-transform">
                                <CircleDashed className="w-32 h-32 animate-spin-slow" />
                            </div>
                            <h4 className="text-xl font-bold mb-3 relative z-10 text-primary-400">Variabilitas Harga</h4>
                            <p className="text-base text-slate-300 leading-relaxed relative z-10 font-medium">
                                "Setiap desa memiliki rintangan unik. Asesmen awal kami memastikan biaya yang Anda keluarkan selaras dengan tingkat pendampingan yang dibutuhkan."
                            </p>
                        </div>

                        <div className="glass p-6 rounded-[32px] border border-emerald-100 bg-emerald-50/20 flex gap-4 items-center">
                            <div className="shrink-0 p-4 rounded-2xl bg-emerald-100 text-emerald-700 shadow-sm border border-emerald-200">
                                <ShieldCheck className="w-8 h-8" />
                            </div>
                            <div>
                                <h4 className="font-bold text-slate-900">Output Strategis</h4>
                                <p className="text-xs text-slate-600 leading-relaxed font-semibold">Laporan Audit, Masterplan Digital, Draf Perdes, & Roadmap Tahunan.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        content: (
            <div className="space-y-12">
                <div className="text-center space-y-4">
                    ...
                    <h2 className="text-3xl md:text-5xl font-display font-bold text-slate-900 leading-tight">Skema Pembiayaan & Kolaborasi</h2>
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg">Solusi investasi teknologi yang tidak membebani APBDes, melainkan menjadi sumber Pendapatan Asli Desa (PADesa).</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* Model 1 */}
                    <div className="glass p-6 md:p-8 rounded-[32px] border border-slate-200 bg-white shadow-sm flex flex-col gap-4">
                    ...
                    {/* Model 2 */}
                    <div className="glass p-6 md:p-8 rounded-[32px] border border-primary-100 bg-primary-50 shadow-md relative overflow-hidden flex flex-col gap-4 transform md:-translate-y-4">
        ...
        content: (
            <div className="space-y-12 h-full flex flex-col justify-center relative overflow-hidden">
                ...
                <div className="text-center space-y-4 relative z-10">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg">Roadmap transformasi digital menuju Desa Mandiri yang cerdas dan berkelanjutan.</p>
                </div>
                ...
                <div className="relative z-10 grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-2">
                    {[
                        ...
                        >
                            ...
                            <div className={`relative z-10 p-5 md:p-6 rounded-[32px] bg-gradient-to-b ${item.color} border ${item.borderColor} backdrop-blur-md shadow-lg group-hover:shadow-2xl group-hover:-translate-y-2 transition-all duration-500 h-full`}>
                                <div className="flex justify-between items-start mb-6">
        ...
        content: (
            <div className="space-y-12 h-full flex flex-col justify-center relative overflow-hidden">
                ...
                <div className="text-center space-y-4 relative z-10">
                    ...
                    <h2 className="text-3xl md:text-6xl font-display font-black text-slate-900 tracking-tight">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg font-medium">Nilai tawar tertinggi untuk kemandirian digital desa yang berkelanjutan.</p>
                </div>
                ...
                <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
                    {[
                        ...
                        <motion.div
                            ...
                            animate={{ opacity: 1, x: 0 }}
                            transition={{ delay: i * 0.1 }}
                            className={`p-6 md:p-8 rounded-[40px] bg-gradient-to-br ${point.color} border ${point.borderColor} backdrop-blur-xl shadow-xl hover:shadow-2xl transition-all duration-500 group flex gap-6 items-start`}
                        >
            ...
            <div className="space-y-10 h-full flex flex-col justify-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-stretch">
                    ...
                    <div className="md:col-span-8 space-y-6">
                        ...
                        {/* Quote */}
                        <div className="glass p-5 md:p-6 rounded-[24px] border border-primary-100 bg-gradient-to-r from-primary-50/50 to-blue-50/50 relative overflow-hidden">
    ...
    },
    {
        id: "outro",
        content: (
            <div className="relative w-full min-h-[500px] md:h-[650px] rounded-[40px] md:rounded-[60px] overflow-hidden flex items-center p-6 md:p-16">
                {/* Background with Cinematic Image & Animated Overlay */}
                <div className="absolute inset-0">
                    <motion.img
                        initial={{ scale: 1.1 }}
                        animate={{ scale: 1 }}
                    ...
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,rgba(14,165,233,0.1),transparent)]" />

                    {/* Animated Data Particles (Decorative) */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                        <div className="space-y-8 text-left">
                            <motion.div
                                initial={{ opacity: 0, x: -20 }}
                                animate={{ opacity: 1, x: 0 }}
                                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-600 text-white text-[10px] md:text-xs font-black uppercase tracking-[0.4em] shadow-xl shadow-primary-200"
                            >
                                Vision for 2025
                            </motion.div>
                            ...
                            <div className="space-y-4">
                                <motion.h2
                                    ...
                                    className="text-4xl md:text-7xl font-display font-black text-slate-900 leading-[1.1] tracking-tighter"
                                >
                                    Kedaulatan <br />
                                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-blue-700">Digital Desa</span>
                                </motion.h2>
                                <motion.p
                                    initial={{ opacity: 0 }}
                                    animate={{ opacity: 1 }}
                                    transition={{ delay: 0.4 }}
                                    className="text-lg md:text-2xl text-slate-600 font-medium leading-relaxed max-w-lg"
                                >
                                    Pilihan strategis untuk kemandirian, efisiensi layanan, dan pemerataan ekonomi yang bermartabat.
                                </motion.p>
                            </div>
                            ...
                            <motion.div
                                ...
                                className="inline-block p-4 rounded-2xl bg-slate-900 text-white shadow-2xl relative group overflow-hidden"
                            >
                                ...
                                <span className="relative z-10 font-bold italic tracking-tight">"Digitalisasi Bukan Opsi, Tapi Masa Depan."</span>
                            </motion.div>
                        </div>

                        <div className="grid grid-cols-1 gap-4">
                            {[
                                { title: "Data Berdaulat", desc: "Kepemilikan penuh database demi keamanan nasional.", icon: <ShieldCheck className="w-6 h-6" />, color: "border-primary-100 bg-primary-50/50" },
                                { title: "Kesenjangan Nol", icon: <Network className="w-6 h-6" />, color: "border-blue-100 bg-blue-50/50" },
                                { title: "Ekonomi Merdeka", icon: <TrendingUp className="w-6 h-6" />, color: "border-indigo-100 bg-indigo-50/50" }
                            ].map((pillar, i) => (
                                <motion.div
                                    key={i}
                                    ...
                                    className={`p-5 rounded-3xl border ${pillar.color} backdrop-blur-md flex items-center gap-5 hover:scale-105 transition-all cursor-default group`}
                                >
                                    <div className="p-3 rounded-2xl bg-white shadow-lg text-primary-600 group-hover:bg-primary-600 group-hover:text-white transition-colors">
                                        {pillar.icon}
                                    </div>
                                    <span className="text-lg font-black text-slate-900 uppercase tracking-tighter">{pillar.title}</span>
                                </motion.div>
                            ))}
                            ...
                            >
                                <h3 className="text-5xl md:text-8xl font-display font-black text-slate-900/10 tracking-tighter uppercase select-none leading-none">
                                    Maju Bersama
                                </h3>
                                <h3 className="text-4xl md:text-6xl font-display font-black text-slate-900 tracking-tighter -mt-6 md:-mt-8 ml-4 md:ml-12 italic">
                                    Terima Kasih
                                </h3>
                            </motion.div>
                        </div>
