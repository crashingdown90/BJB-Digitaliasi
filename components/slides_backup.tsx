...
export const slides: Slide[] = [
    ...
    },
    {
        id: "outro",
        content: (
            <div className="relative w-full min-h-[400px] md:h-[600px] rounded-[32px] md:rounded-[48px] overflow-hidden flex items-center justify-center p-6 md:p-12">
                ...
                <div className="relative z-10 text-center space-y-12 max-w-5xl">
                    <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <h2 className="text-3xl sm:text-5xl md:text-7xl font-display font-black text-slate-900 leading-tight">
                                Membangun Masa Depan <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-blue-600">Desa Indonesia</span>
                            </h2>
                            <p className="text-lg md:text-2xl text-slate-700 font-medium max-w-3xl mx-auto">
                    ...
                    <motion.div
                        ...
                        className="pt-10"
                    >
                        <h3 className="text-4xl sm:text-6xl md:text-8xl font-display font-black text-slate-900 tracking-tighter">
                            Terima Kasih
                        </h3>
                    </motion.div>
                </div>
